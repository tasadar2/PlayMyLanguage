...
namespace PlayMyLanguage.Translation
{
    public abstract class TextTranslator : ITextTranslator
    {
        /// <inheritdoc />
        public event EventHandler<StatusEventArgs> ProgressChanged;

        /// <inheritdoc />
        public abstract Support.Translation Translate(IEnumerable<string> translatables, Language source, Language target);
